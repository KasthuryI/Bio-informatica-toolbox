...
#### We created this website because not all the data produced by sequencing is 100% accurate and when you want to do mapping and covarage of a reference genome you want to use the accurate data. Therefore, this tool was created to help in that process. 

#### It does this by visualizing the FASTQ data with a tool called FASTQC and another tool called Trimommatic for trimming the FASTQ data based on input commands. 

#### This site is for researchers that want a quality check on their sequence data and can trim their sequence based on the quality.
...
## **DISCLAIMER: TrimTech works best with Illumina data**
