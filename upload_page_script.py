                ...
                for line in files:
                    ...
                    if line.startswith("@"):
                        ...
                        return render_template("succes_upload_page.html",
                                                ...
                                                original=session["path_folder"])

                    else:
                        return render_template("failed_upload_page.html",
                                                name=session["filename"])
        else:
...
def options():
    ...
    if request.method == "POST":
        ...
        # running trimmomatic with data and session filename
        trim_object = Trimmomatic(sliding_show,
